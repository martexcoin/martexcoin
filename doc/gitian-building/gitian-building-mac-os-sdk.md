...
The script [extract-osx-sdk.sh](https://github.com/martex-project/martex/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
martex/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/martex-project/martex/blob/master/doc/README_osx.md) for troubleshooting tips.