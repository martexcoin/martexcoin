...
* See the documentation at the [MarteX Wiki](https://github.com/martexcoin/martexcoin/wiki)
...
Development
---------------------
The MarteX repo's [root README](/README.md) contains relevant information on the development process and automated testing.
...
### Resources
* Discuss on the [BitcoinTalk](https://bitcointalk.org/index.php?topic=1354130.0).
