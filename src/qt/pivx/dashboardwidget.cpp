...
DashboardWidget::DashboardWidget(MARTEXGUI* parent) :
    PWidget(parent),
    ui(new Ui::DashboardWidget)
{
    ...
    ui->labelMessage->setText(tr("Amount of MXT earned via Staking & Masternodes"));
    setCssSubtitleScreen(ui->labelMessage);
    setCssProperty(ui->labelSquareMXT, "square-chart-znz");
    setCssProperty(ui->labelSquareMNRewards, "square-chart-mnrewards");
    setCssProperty(ui->labelMXT, "text-chart-znz");
    ...
    ui->labelAmountMNRewards->setText("0 MXT");
    ui->labelAmountMXT->setText("0 MXT");
    setCssProperty(ui->labelAmountMXT, "text-stake-znz-disable");
    ...
    ui->btnHowTo->setText(tr("How to get MXT"));
...
bool DashboardWidget::loadChartData(bool withMonthNames) {
    ...
    chartData->amountsByCache = getAmountBy(); // pair MXT and MN rewards
...
void DashboardWidget::onChartRefreshed() {
    ...
    if (chartData->totalStakes > 0 || chartData->totalMNRewards > 0) {
        setCssProperty(ui->labelAmountMXT, "text-stake-znz");
        setCssProperty(ui->labelAmountMNRewards, "text-stake-mnrewards");
    } else {
        setCssProperty(ui->labelAmountMXT, "text-stake-znz-disable");
        setCssProperty(ui->labelAmountMNRewards, "text-stake-mnrewards-disable");
    }
    forceUpdateStyle({ui->labelAmountMXT, ui->labelAmountMNRewards});
    ui->labelAmountMXT->setText(GUIUtil::formatBalance(chartData->totalStakes, nDisplayUnit) + " (Stakes)");
