...
AddressesWidget::AddressesWidget(MARTEXGUI* parent) :
    PWidget(parent),
    ui(new Ui::AddressesWidget)
{
    ...
    // Address
    ui->labelAddress->setText(tr("Enter MARTEX address"));
    setCssProperty(ui->labelAddress, "text-title");
    ui->lineEditAddress->setPlaceholderText("e.g. MmkEBAFKzay6fMaYp3ZB…");
