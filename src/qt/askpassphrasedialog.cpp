...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        bool ret = openStandardDialog(
                ...
                " <b>" + tr("LOSE ALL OF YOUR MXT") + "</b>!<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),
                tr("ENCRYPT"), tr("CANCEL")
        );
        if (ret) {
            newpassCache = newpass1;
            MARTEXGUI* window = static_cast<MARTEXGUI*>(parentWidget());
...
{
    MARTEXGUI* gui = static_cast<MARTEXGUI*>(parentWidget());
...
{
    hide();
    static_cast<MARTEXGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("MARTEX will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your MXT from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
