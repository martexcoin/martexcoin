...
//
// The Masternode Class. For managing the Anonsend process. It contains the input of the 5000 MXT, signature to prove
...
public:
    ...
    /// Is the input associated with collateral public key? (and there is 5000 MXT - checking if valid masternode)
